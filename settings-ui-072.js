(function(){
  ...
  function settings2(){
    ...
    '<article class="setting-card" style="text-align:center"><h3>'+d.about+'</h3><h2>'+brand()+'</h2><p class="muted">Version 0.8.3</p><p>© 2026 Adam Margoev<br>All Rights Reserved</p></article></section>';
  }
