...
```json
{
  ...
  "english": "English translation from source JSON",
  "ru": "Russian translation based on Arabic + English",
  "ka": "Georgian translation based on Arabic + English"
}
```
...
4. Add only new fields: `ru` and `ka`. The app also accepts `russian`, `georgian`, or `translations.ru` / `translations.ka` if imported from another source.
...
2. Start with `data/bukhari/001_revelation.json` and `data/muslim/001_the_book_of_faith.json`.
3. Add translations.
4. Review in the app.
